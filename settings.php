...
<div class="contact-us">
            ...
            <div class="row contact-us-form">
                <div class="col-lg-7 contact-address">
                    <h3>Contact informations</h3>
                        <p class="sub-paragraph w-60">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum risus mi,<br> pharetra sit amet aliquet sit amet, faucibus in ex. </p>
    ...
                                        </svg>
                                        <p class="px-3 "><a href="">www.trickydot.com</a> <br> <a href="">support@trickydot.com</a></p>
                                      <!-- </div> -->
                                    </div>
    ...
                                        </svg>
                                        <p class="px-3">Puthanathani, <br>Malappuram,<br>Kerala</p>
                                      <!-- </div> -->
                                    </div>
                                </div>
                                </div>
