      ...
      <div class="col-lg-10 wrapper">
        <div class="card custom-card-2">
          <div class="card-body p-3 d-flex align-items-center justify-content-between">
            ...
            <a href="add_faq.php" class="btn btn-success">Add FAQ</a>
          </div>
        </div>
                  ...
                  <div class="card-body p-2 text-center">
                    ...
                    <div class="form-buttons" >
                      <div class="d-flex">
                        ...
                        <br>
                          <form method="post" action="editfaq.php" style="margin-top:-64px; margin-left:40px; margin-bottom: 30px;">
                            <input type="hidden" name="id" value="<?php echo $id ?>">
                            <button type="submit" name="update_faq" class="btn btn-danger ">Update</button>
                          </form>
                    </div>
                  </div>
