    ...
    <div class="col-lg-10 wrapper">
        <div class="card custom-card-2">
          <div class="card-body p-3 d-flex align-items-center justify-content-between">
            ...
            <a href="add_portfolio.php" class="btn btn-success">Add Portfolio</a>
          </div>
        </div>
              ...
              <div class="col-md-3 portfolio">
                <div class="card">
                  <div class="card-body p-2 text-center">
                    ...
                    <h4 class="fw-bold " ><?php echo $name ?></h4><br>
                    ...
                    <br>
                    <form method="post" action="editportfolio.php" style="margin-top:-57px; margin-left:-120px; margin-bottom: 30px;">
                      <input type="hidden" name="id" value="<?php echo $id ?>">
                      <button type="submit" name="update_portfolio" class="btn btn-primary">Update</button>
                    </form>
                  </div>
                </div>
